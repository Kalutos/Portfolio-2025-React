...
const Contact: React.FC<ContactProps> = ({ className = "" }) => {
  ...
  const contactInfo: ContactInfo[] = [
    ...
    },
    {
      ...
      title: "Twitter",
      value: "@votre_handle",
      link: "https://twitter.com/votre_handle",
    },
  ];
  ...
  return (
    <section id="contact" className={`py-16 bg-[#0a192f] ${className}`}>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                projets passionnants. Que ce soit pour une collaboration, un
                projet freelance ou simplement pour échanger sur le
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <div key={index} className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-medium [#ccd6f6]">{info.title}</h4>
                    {info.link ? (
                      <a
                        href={info.link}
            ...
            <div className="pt-8 border-t border-gray-200">
              <h4 className="font-medium text-[#ccd6f6] mb-4">Suivez-moi</h4>
              <div className="flex space-x-4">
                <a
                  href="https://github.com/votre-username"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-800 text-white rounded-lg flex items-center justify-center hover:bg-[#64ffda] transition-colors duration-200"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
              ...
              <button
                ...
                className={`w-full py-3 px-6 rounded-lg font-semibold transition-all duration-200 ${
                  !isFormValid || isSubmitting
                    ...
                    : "bg-blue-600 text-white hover:bg-blue-700 transform hover:translate-y-[-1px] shadow-lg hover:shadow-xl"
                }`}
              >
                {isSubmitting ? (
